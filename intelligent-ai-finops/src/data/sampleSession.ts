...
export const SAMPLE_SPECS: SampleSpec[] = [
  ...
  { modelShort: 'qwen3-next-80b', tier: 'large-oss', inputTokens: 680, outputTokens: 350, latencyMs: 1600, judgeScore: 8.6, team: 'Finance', escalated: false, promptSnippet: 'Draft variance commentary for this P&L.' },
