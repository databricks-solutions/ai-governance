...
The tier-2 domains in this reference mirror **VCH's team structure**: `acute`, `community`, `dgp`
...
skills:
  - name: pipeline-cost-analyzer        # must match SKILL.md frontmatter name
    ...
    owner: cedric.boisvert@databricks.com   # must be listed in governance.yaml
    ...
    approvals:
      steward: cedric.boisvert@databricks.com   # T2: a steward for this domain
...
tier2:
  stewards:                             # one steward list per domain
    infrastructure: [cedric.boisvert@databricks.com, siddesh.ujjni@databricks.com]
    eabi:           [cedric.boisvert@databricks.com, siddesh.ujjni@databricks.com]
    # acute, community, dgp, faa, aa, ed, lmps, maa, quality-analytics ...
tier3:
  council:  [cedric.boisvert@databricks.com, siddesh.ujjni@databricks.com]
  security: [cedric.boisvert@databricks.com, siddesh.ujjni@databricks.com]
```
