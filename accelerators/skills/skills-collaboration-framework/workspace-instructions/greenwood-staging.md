...
(https://dbc-e1d9ab39-ffcf.cloud.databricks.com) — the Tier 2 target (every domain) and a Tier 3
fan-out target.
...
here, and it also receives the **Tier-3** enterprise fan-out. Audiences span VCH's domains — Acute,
