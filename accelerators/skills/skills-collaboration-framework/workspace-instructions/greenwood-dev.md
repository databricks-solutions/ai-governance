...
# Workspace Assistant Instructions — Greenwood (DEV workspace, Tier 1 sandbox + Tier 3 fan-out)
...
also receives the **Tier-3** enterprise fan-out. Audiences span Greenwood's four domains:
**platform**, **analytics**, **finance**, and **governance**.
