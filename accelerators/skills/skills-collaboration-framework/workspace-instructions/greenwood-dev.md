...
(https://dbc-a1b2c3d4-e5f6.cloud.databricks.com) — the Tier 1 sandbox (self-upload) and a Tier 3
fan-out target.
...
also receives the **Tier-3** enterprise fan-out. Audiences span Greenwood's domains — Acute, Community,
