...
description: Analyze CMS HWR 30-day all-cause unplanned readmission outcomes and risk-adjusted
  burden from the VCH Cerner semantic layer — reusing the governed pop_readmit_30d cohort asset
...
across the VCH Cerner inpatient population using the governed semantic layer. It reads two
primary objects in `greenwood_dbw_catalog.vch_cerner`:
...
FROM greenwood_dbw_catalog.vch_cerner.pop_readmit_30d_tbl
...
FROM greenwood_dbw_catalog.vch_cerner.mv_readmit_endpoint
...
- `greenwood_dbw_catalog.vch_cerner.pop_readmit_30d_tbl` — governed 30-day readmission cohort
...
- `greenwood_dbw_catalog.vch_cerner.mv_readmit_endpoint` — governed readmission-rate metric
...
- `greenwood_dbw_catalog.vch_cerner.population_endpoint_features` — per-encounter feature
